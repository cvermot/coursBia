...
Ces formules multiplans ont finalement été abandonnées car les interactions aérodynamiques entre ailes superposées sont nuisibles : le doublement de la surface par le doublement du nombre d'aile ne multiplie pas par 2 la portance ! Ces formules augmentent donc la trainée plus rapidement qu'elles n'augmentent les forces de portance.
