...
\section{L'instrumentation de bord}
	...
	L'altimètre se lit à la façon d'une horloge : l'aiguille longue et fine représente les centaines de pieds, tandis que l'aiguille courte et épaisse représente le milliers de pieds. Sur la plupart des altimètres, une aiguille plus fine permet de décompter les dizaines de milliers de pieds.
...
\end{table}
	...
	\subsection{Les instruments de contrôle de la machine}
		...
		Le compte-tours \anglais{tachymeter} ou tachymètre permet de connaitre le régime de rotation du moteur. Sur beaucoup d'avion, l'hélice est en prise directe sur le moteur, donc cet indicateur indique également la vitesse de rotation de l'hélice.
