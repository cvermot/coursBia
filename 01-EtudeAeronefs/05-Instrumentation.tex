...
\end{table}
	...
	\subsection{Les instruments de contrôle de la machine}
		...
		Cet indicateur permet de contrôler le bon fonctionnement de la génération électrique de bord. Le voltmètre indique la tension de la batterie	tandis que l'ampèremètre permet de vérifier si la batterie est en charge ou en décharge.	
