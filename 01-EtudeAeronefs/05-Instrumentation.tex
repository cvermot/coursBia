...
\end{table}
	...
	\subsection{Les instruments de contrôle de la machine}
		...
		Ces 2 instruments sont essentiellement utilisés pour régler la richesse du mélange air-carburant (voir \ref{chap:etudeAeronef:reglageMelange} \nameref{chap:etudeAeronef:reglageMelange}).		
