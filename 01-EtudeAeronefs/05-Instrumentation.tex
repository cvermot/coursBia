...
\end{table}
	...
	\subsection{Les instruments de contrôle de la machine}
		...
		L'indicateur EGG (pour \textit{Exhaust gas temperature}) est relié à une sonde qui mesure la température des gaz d'échappement. Cet indicateur est utilisé pour régler le mélange air-carburant.
