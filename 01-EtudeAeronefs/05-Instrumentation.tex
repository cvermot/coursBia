...
\section{L'instrumentation de bord}
	...
	\subsubsection{L'indicateur de vitesse}
	 L'\gls{anémomètre} \anglais{anemometers}, également appelé \gls{badin} est un instrument qui permet de mesurer la vitesse de l'avion par rapport à l'air. C'est l'un des instruments le plus important dans un avion. 
	...
	Dans la plupart des avions, le badin est gradué en n\oe uds (kt). La vitesse limite de chaque extrémité des arcs est bien sur propre à chaque type d'avion.
	...
	Le \gls{variomètre} \anglais{variometer} est un instrument qui indique la vitesse verticale (montée/descente) d'un aéronef. Cette vitesse est exprimée en pieds/minutes.
	...
	L'\gls{indicateur de virage} \anglais{turn and slip indicator}, également appelé bille-aiguille, est un instrument qui permet de visualiser l'inclinaison d'un aéronef ainsi que de contrôler le dérapage (lacet).
