...
\subsection{Aérodynes}
	\subsubsection{Aéronef à voilure fixe}
		...
		\paragraph{Avions}
		La mise en mouvement de l'avion \anglais{airplane} grâce à ses moteurs. \\
		
		Il existe une très grande diversité de modèles d'avions, variables en taille, conception et usages.
	...
	Les appareils à voilure tournante \anglais{rotary-wing aircraft}, également appelés aérogires, sont des aéronefs dont la sustentation est assurée par la rotation d'un ou plusieurs rotors.
		...
		\histoire{L'autogire a été inventé avant l'hélicoptère. Le premier vol d'un autogire a été effectué en 1923, contre 1939 pour le premier vol réellement contrôlé pour un hélicoptère.}
