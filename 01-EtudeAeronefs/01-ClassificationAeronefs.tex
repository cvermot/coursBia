...
\subsection{Aérodynes}
	...
	\paragraph{Girodynes}
	Le girodyne \anglais{gyrodyne} est en quelque sorte un hybride entre un hélicoptère et un autogire. Le rotor prinicial est en effet entrainé par le moteur, trandis que la traction est obtenue par un ou plusieurs autres moteurs.
...
\subsection{Engins spatiaux}
	...
	\end{figure}
		...
		\paragraph{Sondes}
		Les sondes spatiales sont des véhicules spatiaux qui quittent l'orbite terrestre pour étudier d'autres objets célestes : autres planètes, soleil, ou encore comète.
