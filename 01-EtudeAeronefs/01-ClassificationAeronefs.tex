...
\subsection{Aérodynes}
	\subsubsection{Aéronef à voilure fixe}
		...
		\paragraph{Planeurs}
		Le planeur \anglais{glider} est un aérodyne dépourvu de moyens de propulsion. Il est donc dépendant de moyens annexes (remorqueur, treuille) pour sa mise en l'air. \\
