...
\fi	
	...
	Ce document comporte plusieurs éléments graphiques animés. Ces illustrations animées sont reconnaissables au jeux de bouton suivants, présents sous l'image :
	\begin{figure}[H]	
	\centering
