...
% Pour activer, les options voulues, décommenter la ligne de l'option considérée (ou la passer en paramètre au compilateur, par exemple avec latexmk '-usepretex="\\newcommand{\\opendys}{}"' pour l'option fonte OpenDyslexic
