 ...
 \section{Aérodrome}
	...
	\begin{columns}
		\begin{column}{0.55\textwidth}
			\begin{itemize}
				\item Si un aéroport a plusieurs pistes parallèles, on les nomme suffixe avec leur position gauche (L, left), droite (R, right), et s'il y en a 3, centre (C, center)
			\end{itemize}
		\end{column}
