 ...
 \subsection{La portance}
	...
	\begin{frame}{Finesse}
		\begin{figure}[H]
  			...
  			\legende{Courbe de la finesse de l'incidence}{img:portanceTraineeFinesse}	
		\end{figure}
	\end{frame}
	...
	\end{itemize}
	\pause
	$\Rightarrow$ les dispositifs hypersustenteurs sont utilisés uniquement quand on veux voler plus lentement
