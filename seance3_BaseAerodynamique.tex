...
\begin{document}
 ...
 \subsection{La portance}
	...
	\begin{frame}{Les forces sur un aéronef}[allowframebreaks]
		\begin{figure}[H]
			\only<1>{\includegraphics[scale=1.2]{imgPresentations/forces.pdf}}
	...
	\item $Cx$ : coefficient de traînée (sans unité), valeur liée à la forme de l'aile et à l'incidence
	\end{itemize}
