...
\begin{document}
 ...
 \begin{frame}{Différentes configurations d'ailes : les multiplans}
 	Au début de l'aviation, on multiplie les ailes pour augmenter la portance et la rigidité. On parle de l'air des multiplans (par opposition aux monoplans).
 ...
 \begin{figure}[H]
  		...
  		\legende{Quandriplan}{wing:Quadruplane}	
		\end{figure}
 \end{column}
 \end{columns}
 ...
 \begin{frame}{Différentes configurations d'ailes : le dièdre}
	Le dièdre est angle formé par le plan de chaque aile et le plan horizontal . Il peut-être positif, nul ou négatif. Le dièdre a un impact sur la stabilité.
 ...
 \begin{frame}{Les principales disposition de cylindres - moteur en ligne}
	\begin{figure}[H]
  	...
  	\legende{Moteur à plat 4 cylindres}{video:flat4}
	\end{figure}
\end{frame}
