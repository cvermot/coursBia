...
\begin{document}
 ...
 \begin{frame}{Description générale - aile}
 	\begin{figure}[H]
  		\only<1>{\includegraphics[scale=0.6]{01-EtudeAeronefs/img/schemaAileSansLegende.pdf}}
...
\section{Turbomoteurs}
 ...
 \begin{frame}{Turboréacteur simple flux}
 	\begin{figure}[H]
  		...
  		\legende{Schéma d'un turboréacteurs simple corps simple flux}{img:turboreacteur-simpleFlux}
	\end{figure}	
  \end{frame}
  \begin{frame}{Turboréacteur double flux}
	\begin{figure}[H]
  		...
  		\legende{Schéma d'un turboréacteurs double corps double flux}{img:turboreacteur-doubeFlux}
		\end{figure}	
 \end{frame}
