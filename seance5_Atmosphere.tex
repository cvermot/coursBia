 ...
 \section{L'atmosphère}
	...
	\begin{frame}{Front froid~~~~\includegraphics[width=0.3\linewidth]{03-Meteo/img/legendeFrontFroid.pdf}}
		...
		A l'interface, l'humidité dans l'air chaud  se condense et forme des nuages développés verticalement : les précipitations sont brèves mais intenses.
			...
			Après le passage du front froid, la traîne s'installe :  une zone de temps instable qui se forme à l'arrière d'un front froid. Elle est caractérisée par une visibilité variable et des averses intermittentes.
	\end{frame}
	...
	\begin{frame}{Front chaud~~~~\includegraphics[width=0.3\linewidth]{03-Meteo/img/legendeFrontChaud.pdf}}
		...
		Le début du front chaud est caractérisé par des nuages de haute altitude. Avec l'avancée du front, la base des nuages descend progressivement, on trouve des précipitations puis des nuages qui peuvent aller jusqu'au sol.
	\end{frame}
