...
\begin{document}
 ...
 \section{L'atmosphère}
	...
	\begin{frame}{Quantité d'eau que peu contenir l'air, selon la température}
	\begin{figure}[H]
			\centering
	...
	\begin{frame}{Composition de l'atmosphère : influence de la quantité de vapeur d'eau}
		...
		Pour une proportion d'eau fixée dans l'atmosphère, la température à laquelle la saturation est atteinte est appelé \textbf{point de rosée}.
	\end{frame}
 	...
 	\begin{frame}{Les couches de l'atmosphère terrestre}
		...
		\end{column}
 		\begin{column}{0.6\textwidth}
 			...
 			L'altitude de la tropopause varie selon la latitude : 9 km au pôle et 17 km à l'équateur. A nos latitudes, la tropopause est à environ 11 km d'altitude, il y fait -56\textdegree C.
 		\end{column}
 		\end{columns}
	\end{frame}	
	
	\begin{frame}{La pression atmosphérique}
	Toute la masse d'air au dessus de nous est soumis à la gravité terrestre. Il a donc un poids (au niveau de la mer : $1,225 kg/m^3$)
	...
	\begin{frame}{Front froid~~~~\includegraphics[width=0.3\linewidth]{03-Meteo/img/legendeFrontFroid.pdf}}
		...
		A l'interface, l'humidité dans l'air chaud  se condense et forme des nuages développés verticalement : les précipitations sont brèves mais intenses.
			...
			Après le passage du front froid, la traîne s'installe :  une zone de temps instable qui se forme à l'arrière d'un front froid. Elle est caractérisée par une visibilité variable et des averses intermittentes, intenses, voir des orages.
	\end{frame}
	...
	\begin{frame}{Front chaud~~~~\includegraphics[width=0.3\linewidth]{03-Meteo/img/legendeFrontChaud.pdf}}
		...
		L'air chaud arrive sur l'air froid, plus dense. Il n'arrive pas à le pousser donc passe au dessus. La vapeur d'eau contenue dans le cet air chaud se condense au contact de l'air plus froid.
	...
	\begin{frame}{Front occlus~~~~\includegraphics[width=0.3\linewidth]{03-Meteo/img/legendeFrontOcclus.pdf}}
		...
		Un front est occlus quand le un front froid rattrape un front chaud.
