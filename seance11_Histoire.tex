 ...
 \section{Un rêve humain intemporel : voler}
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{Vol d'Otto Lilienthal en 1895}{frise:Otto_Lilienthal_gliding_experiment_ppmsca.02546}
		\end{figure}	
		\end{column}
		\begin{column}{0.6\textwidth}
...
Il s'agit du premier vol contrôlé d'un aérodyne motorisé.
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{Portrait de Robert Esnault-Pelterie}{frise:Robert_Esnault-Pelterie_1909}
		\end{figure}	
		\end{column}
		\begin{column}{0.6\textwidth}
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{Carte illustrant les lignes de l'aéropostale entre la France et l'Amérique du Sud, en 1930.}{frise:AC3A9ropostale._AmC3A9rique_du_Sud._Maroc_-_AlgC3A9rie_-_Afrique_Occidentale_FranC3A7aise_-_affiche_-_btv1b10104627j}
		\end{figure}	
		\end{column}
		\begin{column}{0.6\textwidth}
...
Dès 1919, la ligne est étendue jusqu'à Casablanca. Elle sera par la suite prolongée jusqu'à Dakar puis l'Amérique du Sud via Rio au Brésil, puis jusqu'à Buenos-Aires et Santiago du Chili.
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{L'autogire C-6 de Juan de la Cierva (1925)}{frise:Autogyro_at_Farnborough2C_1925_28Our_Generation2C_193829}
		\end{figure}	
		\end{column}
		\begin{column}{0.6\textwidth}
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{Portrait de Charles Lindbergh}{frise:Col_Charles_Lindbergh2C_original2C_hec.21329}
		\end{figure}	
		\end{column}
		\begin{column}{0.6\textwidth}
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{Portrait de Charles Lindbergh}{frise:Amelia_Earhart_1935}
		\end{figure}	
		\end{column}
		\begin{column}{0.6\textwidth} 
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{Le Focke-Wulf Fw 61 en vol}{frise:Fw_61_V}
		\end{figure}	
		\end{column}
		\begin{column}{0.6\textwidth}
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{Le Messerschmitt Me 262, premier chasseur à réaction}{frise:Messerschmitt_Me_262A_at_the_National_Museum_of_the_USAF}
		\end{figure}	
		\end{column}
		\begin{column}{0.6\textwidth}
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{Réplique de missile V2}{frise:La2-v2}
		\end{figure}	
		\end{column}
		\begin{column}{0.6\textwidth}
...
À la fin de la guerre, Wernher von Braun sera recruté par les États-Unis pour développer leur programme spatial.
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{Un Lockheed L1649 Constellation de la TWA}{frise:Lockheed_L-1649_Constellation_TWA}
		\end{figure}	
		\end{column}
		\begin{column}{0.6\textwidth}
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{Le prototype du Comet 1}{frise:Comet_Prototype_at_Hatfield}
		\end{figure}	
		\end{column}
...
Un an après la mise en service commerciale, le Comet connaît des problèmes : trois appareils sont détruits en plein vol. Ils sont dus à la fatigue du métal. Les appareils sont retirés du service et soumis à des essais intensifs afin d'en découvrir la cause. Les défauts de conception, dont les contraintes dangereuses aux coins des hublots carrés et la méthode d'installation, sont immédiatement identifiés. En conséquence, le Comet est entièrement redessiné, avec des hublots ovales, une structure renforcée et d'autres modifications.
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{Boeing 707 de Quantas}{frise:Boeing_707-138B_Qantas_Jett_Clipper_Ella_N707JT}
		\end{figure}	
		\end{column}
		\begin{column}{0.6\textwidth}
...
Bien qu'il ne soit pas le premier jetliner en service, le 707 est le premier à rencontrer un succès commercial. Dominant le transport aérien de passagers dans les années 1960 et restant populaire dans les années 1970, le 707 est souvent considéré comme ayant inauguré l'ère du jet.
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{Boeing 747-200 en 1980}{frise:B-747_Iberia}
		\end{figure}	
		\end{column}
		\begin{column}{0.6\textwidth}
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{Un Concorde de British Airways}{frise:British_Airways_Concorde_G-BOAC_03}
		\end{figure}	
		\end{column}
		\begin{column}{0.6\textwidth}
...
Concorde demeure à ce jour le seul avion supersonique qui aura eu une carrière commerciale notable puisque sa carrière durera de 1976, date de son premier vol commercial, à 2003.
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{Le premier A320 d'Air France, livré en 1988}{frise:Airbus_A320-100_Air_France_28AFR29_F-GFKQ_-_MSN_002_281065593121329}
		\end{figure}	
		\end{column}
		\begin{column}{0.6\textwidth}
	...
	\begin{columns}
		...
		\begin{figure}[H]
			...
			\legende{Spoutnik 1}{frise:Sputnik_asm}
		\end{figure}	
		\end{column}
		\begin{column}{0.6\textwidth}
			 En 1957, l'URSS lance Spoutnik, le premier satellite artificiel. Le "bip bip" émis par ce satellite deviendra l'un des sons iconiques de la conquête spatiale.
			 
			 \begin{figure}[H]
  	\scalebox{.15}{\embedvideo*{\includegraphics[page=1, scale=1]{imgPresentations/Kansas_Cosmosphere_Sputnik_1_2008.jpg}}{imgPresentations/spoutnik_beep.mp4}}
  	\legende{bip de Spoutnik}{video:v6}
	\end{figure}
		\end{column}
		\end{columns}
	\end{frame}
