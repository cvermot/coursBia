...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            L'ingénieur français Paul Cornu réalise le premier vol d'un hélicoptère à deux rotors contrarotatifs, s'élevant d'environ 1,5 mètre du sol pendant 20 secondes. Cette date marque la naissance de l'hélicoptère, mais ce vol n'es pas considéré comme complètement contrôlé
            \begin{figure}[H]
