...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            L'Allemagne nazie réalise le premier lancement réussi d'un missile V2. Ce type de missile, mis au point sous l'égide de Wernher von Braun, sont des fusées utilisées pour bombarder principalement le Royaume-Uni et la Belgique.
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Félicette est une chatte séléctionnée par le Centre interarmées d'essais d'engins spéciaux et qui deviendra le premier êre vivant envoyé dans l'espace par la France (et premier félin dans l'espace). 
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{19 avril 1971} - \textbf{Saliout 1 : premier station spatiale}
...
Ce vol orbital sera le premier et le dernier de la navette Bourane, victime des coupes bidgétaire de la fin de l'empire soviétique, ce projet demeurerant le plus important et le plus coûteux de l’histoire de l’exploration spatiale soviétique.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            La Chine lance sa station spatiale et devient ainsi la troisième nation (après l'URSS/Russie et les USA) à lancer seule une station orbitale. Cette station permettra à 2 équipages d'y vivre sur des missions d'environ 2 semaines, avant la fin de vie opérationnelles de cette station, en 2016.
