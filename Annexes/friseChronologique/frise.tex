...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{1858} - \textbf{Nadar réalise la premieère photographie aérienne}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Le 19 aout 1013, Adolphe Pegoud est le premier pilote de l'histoire à utiliser un parachute pour abandonner un avion en perdition.
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Marcel Dassault (qui s'appelait alors Marcel Bloch) dessins l'hélice Éclair. Cette hélice à marqué l'histoire car elle est très performante. Elle sera produite à plus de 4000 exemplaire et montée sur 10 des 20 avions les plus perfomants de l'armée française de cette époque.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{09 février 1969} - \textbf{Pemier vol du Boeing 747}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            La sonde americaine Viking 1 est la seconde sonde à se poser sur la planète Mars, 5 ans après la première du genre par la sonde soviétique Mars 3.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Le système de géopostionnement par satellites americain, le GPS, devient officiellement pleinement opérationnel pour les usags civils avec 24 satellites en service.

Les systèmes de postionnement par satellites GNSS révolutionnent la façon de voyager en permettant de connaitre sa position de façon très précise en tout lieu sur la planète.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Le 13 février 2016, Sophie Adenot déceolle à bord d'une fusée Space X à destination de la station spatiale internationale. Elle devient la seconde femme française astronaute.
            \begin{figure}[H]
