...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            \begin{figure}[H]
                \legende{Le Croix du Sud, avion a bord duquel Jean Mermoz disparaitrat en mer en 1936}{frise:LatC3A9coere_300_Croix-du-Sud.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
...
Elle devient ainsi le onzième astronaute français après (année des missions, durée totale passée dans l'espace) :
