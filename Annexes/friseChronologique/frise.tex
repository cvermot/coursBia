...
L'histoire raconte que l'avion qu'il venait de quitter aurait alors effectué un looping. C'est de cet événement qu'Adolphe Pegoud aurait tiré l'idée de réaliser un looping à bord de son avion, chose qu'il réalise le 21 septembre.
            \begin{figure}[H]
...
A la fin de la guerre, Wernher von Braun sera recruté par les États-Unis pour développer leur programme spatial
            \begin{figure}[H]
...
La fusée Diamant est considerée comme la première fusée française. Auparavant, la France disposait de lanceurs comme Véronique, mais qui ne sont pas considerées comme des fusés à part entière (fusée-sonde) car incapables de placer des objets en orbite.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{10 juin 2020} - \textbf{Le Velis Electro : premier avion éléctrique certifié au monde}
            
            L'avion biplace de la société slovène Pipistrel est certifié par l'EASA et devient le premier avion éléctrique certifié au monde.
            \begin{figure}[H]
