...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{1907} - \textbf{Invention du manche à balai}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{1908} - \textbf{Thérèse Peltier, première femme à quitter le sol}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{1909} - \textbf{Louis Blériot obtient le premier brevet de pilote}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{1911} - \textbf{Premier usage d'avions au combat}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{1915} - \textbf{Premier vol du Junker J1, premier avion entièrement métallique}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{1916} - \textbf{Marcel Bloch concoit l'hélice Éclair}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{1953} - \textbf{Jacqueline Cochran, première femme à passer le mur du son}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{2014} - \textbf{La sonde Rosetta dépose l'atterisseur Philea sur la comète Tchouri}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{2026} - \textbf{Sophie Adenot, seconde française dans l'espace}
