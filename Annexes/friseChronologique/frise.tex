...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Le tube de Pitot est inventé en 1732 par le physicien Henri Pitot, pour la mesure de la vitesse des bateaux ou des vitesses d'écoulement de l'eau dans les rivières. Le tube de Pitot sera ensuite utilisé en aéronautique dans les dispositifs de mesure de vitesse des aéronefs.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Pilâtre de Rozier s'élève dans le ciel grâce à la montgolfière des frères Montgolfier.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            L'inventeur français Jacques Charles effectue le premier vol en ballon à gaz, gonflé à l'hydrogène. Ce type de ballon permet des vols plus longs et plus hauts que les ballons à air chaud.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{04 juin 1784} - \textbf{Élisabeth Tible, première femme à voler}
            
            Élisabeth Tible est une aéronaute française, née le 8 mars 1757 à Lyon et morte le 13 février 1785 à Paris. Elle est considérée comme la première femme de l'histoire à avoir effectué un vol à bord d'un aérostat libre. L'événement a lieu le 4 juin 1784 à Lyon, à bord de la montgolfière nommée La Gustave.

Durant ce vol, d'une durée de 45 minutes, elle atteindra une altitude estimée à 1500 m, battant à ce titre 2 records : celui de distance et celui d'altitude.
            \begin{figure}[H]
                \legende{L'envol de La Gustave}{frise:Montgolfiere_La_Gustave_par_Charles-Ange_Boily.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Montgolfiere_La_Gustave_par_Charles-Ange_Boily.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
...
Son dirigeable était propulsé par un moteur à vapeur.
            \begin{figure}[H]
                \legende{Vol du 24 septembre 1852 du dirigeable à vapeur d'Henri Giffard, d'après la gravure de L. Guiguet}{frise:premierVolDirigeable.png}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/extraitsVideo/premierVolDirigeable.png}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            L'ingénieur allemand Otto Lilienthal fait voler son planeur, en se lançant depuis une colline.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Les frères Orville et Wilbur Wright font voler leur avion aux États-Unis.
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{13 novembre 1907} - \textbf{Paul Cornu : premier vol d'hélicoptère}
            
            L'ingénieur français Paul Cornu réalise le premier vol d'un hélicoptère à deux rotors contrarotatifs, s'élevant d'environ 1,5 mètre du sol pendant 20 secondes. Cette date marque la naissance de l'hélicoptère, mais ce vol n'est pas considéré comme complètement contrôlé, ainsi on retiendra également 1936 et le vol du Focke-Wulf 61 comme véritable naissance de l'hélicoptère utilisable opérationnellement.

            \begin{figure}[H]
                \legende{Hélicoptère de Paul Cornu}{frise:HE2G8.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/HE2G8.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Le 8 juillet 1908, Thérèse Peltier devient la première femme à quitter le sol avec un aéronef, dans un avion piloté par son compagnon Léon Delagrange.

Elle deviendra la première femme à voler seule à bord d'un avion quelques mois plus tard, lors de son lâcher solo.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Élisa Deroche s'intéresse à l'aviation depuis l'année 1906.
...
La semaine internationale des femmes de l'air marque désormais chaque année cette date historique, puisque cette semaine est positionnée sur la semaine du 8 mars. 
            ...
            \begin{figure}[H]
                \legende{Élisa Deroche aux commandes d'un biplan Voisin.}{frise:Les_Maitres_de_l27aviation._Mme._la_Baronne_de_Laroche2C_aviatrice2C_au_poste_de_direction_d27un_biplan_Voisin._cph.3c07402.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            L'ingénieur français Henri Fabre devient le premier à décoller d'un plan d'eau avec un aéronef qui dispose de son propre moyen de propulsion. Cette date marque l'entrée dans l'ère de l'hydraviation qui aura son âge d'or sur la période de l'entre-deux-guerres.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            L'inventeur français invente un dispositif permettant la mesure de la vitesse de l'air dans lequel évolue un aéronef. L'anémomètre est parfois appelé "badin" du nom de cet inventeur.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Le 19 août 1913, Adolphe Pégoud est le premier pilote de l'histoire à utiliser un parachute pour abandonner un avion en perdition.

L'histoire raconte que l'avion qu'il venait de quitter aurait alors effectué un looping. C'est de cet événement qu'Adolphe Pégoud aurait tiré l'idée de réaliser un looping à bord de son avion, chose qu'il réalise le 21 septembre.

            \begin{figure}[H]
                \legende{Carte postale allemande illustrant le looping d'Adolphe Pégoud.}{frise:Adolphe_PC3A9goud_Looping.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            René Fonck est le pilote français ayant le plus grand nombre de victoires aériennes (75). Il est surnommé "l'as des as".
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{1914} - \textbf{Manfred von Richtofen, as de la première guerre mondiale}
            
            Manfred von Richtofen, pilote allemand, dispose du plus grand nombre de victoires confirmées (80) lors du premier conflit mondial.

Il est connu sous le nom du Baron rouge.
            \begin{figure}[H]
                \legende{Le Baron Rouge, Manfred von Richtofen}{frise:Manfred_von_Richthofen.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{01 février 1916} - \textbf{Marcel Bloch conçoit l'hélice Éclair}
            
            Marcel Dassault (qui s'appelait alors Marcel Bloch) dessine l'hélice Éclair. Cette hélice a marqué l'histoire car elle est très performante. Elle sera produite à plus de 4000 exemplaires et montée sur 10 des 20 avions les plus performants de l'armée française de cette époque.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{01 avril 1921} - \textbf{Adrienne Bolland, première femme à traverser la Cordillère des Andes}
            
            Adrienne Bolland traverse la Cordillère des Andes en Caudron G3 en 4h15.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    \begin{tabular}{c l c}
        \begin{minipage}{.075\textwidth}
            ...
            \setlength{\belowcaptionskip}{-40pt}
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Flag_of_Norway.pdf}
                \captionsetup{labelformat=empty}\refDrapeau{Drapeau Norway}{frise:Flag_of_Norway.pdf}
            \end{figure}
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{12 mai 1926} - \textbf{Amundsen survole le pôle nord en dirigeable}
            
            Roald Amundsen, norvégien célèbre pour avoir été le premier à rejoindre le pôle Sud, sera également le premier à survoler l'un des pôles de notre planète, grâce à un dirigeable de type Norge N1.
            \begin{figure}[H]
                \legende{Dirigeable Norge N1 utilisé pour l'atteinte du pôle Nord}{frise:Norge_airship_in_flight_1926.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Norge_airship_in_flight_1926.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{20 mai 1927} - \textbf{Charles Lindbergh réalise le premier vol transatlantique }
            
            Charles Lindbergh réalise le premier vol transatlantique entre New-York et Paris, à bord de son avion,  le Spirit of Saint-Louis  en 33h30. Il avait emporté a bord 1700 l de carburant (et consommé environ 1400 l durant la traversée).
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{13 juillet 1928} - \textbf{Maryse Bastié, première recordwoman de distance}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            \begin{figure}[H]
                \legende{Le Croix du Sud, avion à bord duquel Jean Mermoz disparaîtra en mer en 1936}{frise:LatC3A9coere_300_Croix-du-Sud.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
...
Le 20 mai 1932, elle réitère la traversée, mais cette fois-ci, seule. Elle effectue en une quinzaine d'heures sur son Lockheed Vega la traversée entre le Canada et l'Irlande du Nord.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Le britannique Robert Watson-Watt dépose un brevet pour le radar, qui permet de détecter à distance des objets, et notamment des avions. Durant la seconde guerre mondiale, cette invention donnera un avantage décisif aux britanniques durant la bataille d'Angleterre (1940).
            \begin{figure}[H]
                \legende{Composant d'un radar conçu par Robert Watson-Watt}{frise:Watson_Radar.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Le Douglas DC-3, surnommé "Dakota", révolutionne le transport aérien commercial à partir du milieu des années 1930. Fiable, économique et confortable, il sera produit à plus de 16 000 exemplaires et utilisé massivement durant la Seconde Guerre mondiale.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Le Focke-Wulf Fw 61 est le premier hélicoptère ayant effectué un vol totalement contrôlé.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    \begin{tabular}{c l c}
        \begin{minipage}{.075\textwidth}
            ...
            \setlength{\belowcaptionskip}{-40pt}
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Flag_of_Japan.pdf}
                \captionsetup{labelformat=empty}\refDrapeau{Drapeau Japan}{frise:Flag_of_Japan.pdf}
            \end{figure}
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{07 décembre 1941} - \textbf{Attaque de Pearl Harbor}
            
            Le 7 décembre 1941, le Japon attaque la base américaine de Pearl Harbor (Hawaï) au moyen de chasseurs et bombardiers lancés depuis des porte-avions. Cette attaque fait entrer les États-Unis dans la Seconde Guerre mondiale et démontre la puissance de l'aviation embarquée.
            \begin{figure}[H]
                \legende{Mitsubishi A6M "Zero" - Porte Avions Akagi - photo de la seconde vague d'attaque sur Pearl Harbor 7 déc 41}{frise:Zero_Akagi_Dec1941.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Zero_Akagi_Dec1941.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{1942} - \textbf{Normandie-Niemen, escadrille française en URSS}
            
            L'escadrille de chasse "Normandie-Niemen", composée de pilotes français libres, combat aux côtés de l'armée soviétique sur le front de l'Est durant la Seconde Guerre mondiale. Elle remporte 273 victoires et devient une légende.
            \begin{figure}[H]
                \legende{Insigne du Normandie-Niemen}{frise:D0ADD0BCD0B1D0BBD0B5D0BCD0B0_D09DD0BED180D0BCD0B0D0BDD0B4D0B8D18F_E28094_D09DD0B5D0BCD0B0D0BD.pdf}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/D0ADD0BCD0B1D0BBD0B5D0BCD0B0_D09DD0BED180D0BCD0B0D0BDD0B4D0B8D18F_E28094_D09DD0B5D0BCD0B0D0BD.pdf}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            L'Allemagne nazie réalise le premier lancement réussi d'un missile V2. Ces missiles, mis au point sous l'égide de Wernher von Braun, sont des fusées utilisées pour bombarder principalement le Royaume-Uni et la Belgique.
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Le Lockheed Constellation est un avion de ligne quadrimoteur à hélice. En tant que premier avion de ligne pressurisé en utilisation généralisée, le Constellation inaugure l'ère du service aérien abordable et confortable.
            \begin{figure}[H]
...
Cette réglementation produite par l'OACI a permis depuis la fin de la Seconde Guerre mondiale la mise en œuvre du transport aérien, tant des personnes que des biens, au niveau mondial, grâce à des recommandations suivies par l'ensemble des États membres, des équipementiers de l'aéronautique et fabricants d'avions, des établissements responsables d’aéroports...
    ...
    \end{tabular}
\end{table}
\section{L'âge d'or de la réaction et la guerre froide}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Le De Havilland Comet est le premier avion de ligne à réaction à entrer en service commercial.
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{05 mai 1961} - \textbf{Alan Shepard, premier américain dans l'espace}
            
            Alan Shepard devient le premier américain dans l'espace, à bord de son vaisseau Mercury-Redstone 3.

Son séjour dans l'espace sera bien plus court (environ 15 minutes) que celui de Youri Gagarine, car Shepard effectue seulement un vol suborbital et non une orbite autour de la Terre. Il faudra attendre le vol de John Glenn pour que les américains effectuent une orbite équivalente à celle des soviétiques.
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            La soviétique Valentina Terechkova devient la première femme s'être rendue dans l'espace, lors de la mission Vostok 6, à l'âge de 26 ans. Elle demeure, à ce jour, la plus jeune femme à s'être rendue dans l'espace.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{18 octobre 1963} - \textbf{Félicette : premier chat dans l'espace}
            
            Félicette est une chatte sélectionnée par le Centre interarmées d'essais d'engins spéciaux et qui deviendra le premier le premier félin dans l'espace.

Elle effectue un vol suborbital à bord d'une fusée Véronique, atteint 157 km d'altitude (et vit 5 minutes d'apesenteur) et revient sur Terre vivante après 13 minutes de vol.

Avant Félicette, la France a envoyé dans l'espace 3 rats. Le premier se nomme Hector et est lancé également à bord d'une fusée Véronique le 22 février 1961. À cette occasion, la France devient le troisième pays à lancer des animaux dans l'espace.
            \begin{figure}[H]
                \legende{Photo de Félicette}{frise:Felicette2C_spacecat.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Felicette2C_spacecat.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{26 novembre 1965} - \textbf{Asterix, premier satellite français en orbite grâce à une fusée Diamant}
            
            La France lance en 1965 son premier satellite : Asterix. Il est lancé par une fusée Diamant-A, également de conception française.
...
La fusée Diamant est considérée comme la première fusée française. Auparavant, la France disposait de lanceurs comme Véronique, mais qui ne sont pas considérées comme des fusées à part entière (fusée-sonde) car incapables de placer des objets en orbite.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            "Un petit pas pour l'Homme, un bond de géant pour l'Humanité". Neil Armstrong est le premier humain à fouler le sol lunaire durant la mission Apollo 11. Leur vaisseau lunaire, propulsé par une fusée Saturne 5, lui permettra, ainsi qu'à ses collègues de mission, Buzz Aldrin et Michael Collins (ce dernier étant resté en orbite autour de la Lune durant la mission), de rentrer dans l'Histoire.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{19 avril 1971} - \textbf{Saliout 1 : première station spatiale}
            
            Les soviétiques mettent en orbite la première station spatiale. Après qu'un premier équipage soit parvenu à accoster à la station sans pouvoir y pénétrer, un équipage y vivra pendant 23 jours.

Cet équipage, de la mission Soyouz 11, décédera lors de son retour sur Terre, à cause d'un défaut de la capsule qui provoque sa dépressurisation alors qu'elle se trouve encore dans l'espace.
            \begin{figure}[H]
                \legende{Timbre illustrant la station Saliout 1}{frise:1972_CPA_4112.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/1972_CPA_4112.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{02 décembre 1971} - \textbf{Premier atterrissage réussi d'un objet humain sur Mars}
            
            L'atterrisseur de la sonde soviétique Mars 3 parvient à atterrir avec succès sur la planète Mars. Il s'agit du premier atterrissage réussi d'un objet humain sur la planète Mars.
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{14 mai 1973} - \textbf{Station spatiale SkyLab}
            
            Les américains mettent en orbite, Skylab, leur station spatiale grâce à une fusée Saturn V, dont ce sera le dernier vol. Cette station restera dans l'espace 2249 jours dont 171 jours occupée par 3 équipages.
            \begin{figure}[H]
                \legende{Photo de la station Skylab}{frise:Skylab_28SL-429.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Skylab_28SL-429.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            \begin{figure}[H]
                \legende{Vue d'artiste de la sonde Viking 1 larguant son module d'atterrissage}{frise:Viking_Orbiter_releasing_the_lander.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{24 décembre 1979} - \textbf{Premier lancement d'Ariane 1}
            
            Ariane 1 est la première fusée de l'Agence Spatiale Européenne. Cette fusée, comme toutes les Ariane, sera tirée à Kourou, situé en Guyane, département français d'outre-mer situé en Amérique du Sud, proche de l'équateur.
            \begin{figure}[H]
                \legende{Fusée Ariane 1 au musée du Bourget}{frise:Ariane_1_Le_Bourget_FRA_001.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Ariane_1_Le_Bourget_FRA_001.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            La navette Columbia, affectée à la mission STS-1, effectue le vol inaugural des navettes spatiales américaines.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{19 février 1986} - \textbf{Mir : la station spatiale Soviétique}
            
            En 1986, les soviétiques lancent la station Mir (du russe Мир :"Paix"). C'est la première station spatiale occupée de façon prolongée puisqu'elle sera en orbite jusqu'en 2001 et connaîtra une période d'occupation permanente pendant 10 ans, de 1989 à 1999.

Cette station verra également naître la véritable coopération spatiale puisqu'elle s'ouvrira progressivement aux astronautes non soviétiques ou russes, avec l'accueil d'astronautes américains, européens, japonais ou encore indiens. La coopération aboutira même au programme Shuttle-Mir, qui permettra l'accostage des navettes spatiales américaines à la station.
            \begin{figure}[H]
                \legende{La station Mir}{frise:Mir_from_STS-81.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Mir_from_STS-81.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            L'A320 est le premier avion de ligne équipé de commandes de vol électriques numériques.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{15 novembre 1988} - \textbf{Premier vol de la navette spatiale soviétique : Bourane}
            
            Les soviétiques réalisent le premier (et unique) vol orbital de leur navette spatiale Bourane.

Ce vol d'essai sera réalisé sans équipage, la navette réalisant de façon automatique toutes les procédures de désorbitage et d'atterrissage, ce qui est une caractéristique unique pour une navette spatiale (la navette américaine n'a pas cette capacité).

Ce vol orbital sera le premier et le dernier de la navette Bourane, victime des coupes budgétaire de la fin de l'empire soviétique, ce projet demeurant le plus important et le plus coûteux de l’histoire de l’exploration spatiale soviétique.
            \begin{figure}[H]
                \legende{Bourane sur son avion transporteur (qui servira également pour le lancement de la navette pour ses essais atmosphériques) An-225.}{frise:Antonov_An-225_with_Soviet_space_shuttle_Buran_on_top.jpeg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Antonov_An-225_with_Soviet_space_shuttle_Buran_on_top.jpeg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{24 avril 1990} - \textbf{Le télescope spatial Hubble en orbite}
            
            Le télescope spatial Hubble est mis en orbite par la navette spatiale Discovery.
...
Fait notable : ce satellite a fait l'objet de 5 visites de maintenance, réalisées par les navettes spatiales américaines. La première mission de maintenance, en 1993 permet notamment de corriger des défauts du miroir qui rendait Hubble "myope". On notera également la présence d'un astronaute français, Jean-François Clervoy, lors de la troisième mission de maintenance, STS-103.
            \begin{figure}[H]
...
Les systèmes de positionnement par satellites GNSS révolutionnent la façon de voyager en permettant de connaître sa position de façon très précise en tout lieu sur la planète.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{17 août 1996} - \textbf{Claudie Haigneré, première astronaute française}
            
            14 ans après le premier français dans l'espace, Claudie Haigneré devient la première française (et première femme européenne non soviétique) dans l'espace, avec un séjour dans la station russe Mir.
...
La station spatiale internationale sert de laboratoire pour des expériences scientifiques. En février 2026, on dénombre 292 personnes originaires de 26 pays ayant séjourné dans la Station spatiale internationale.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{01 mars 1999} - \textbf{Bertrand Piccard réalise le premier tour du monde en ballon sans escale}
            
            Bertrand Piccard réalise, à la troisième tentative, le premier tour du monde sans escale en ballon de l'histoire, grâce au Breitling Orbiter III, un ballon à l'hélium conçu spécialement pour ce record. Ce ballon est notamment équipé d'une nacelle pressurisée.

Le tour du monde est finalement bouclé après avoir volé 19 jours 21 heures et 47 minutes (447 h et 47 min) sur une distance de 45 755 km, soit le plus long vol en durée et en distance de l’histoire de l’aviation.
            \begin{figure}[H]
                \legende{Une copie du Breitling Orbiter 3 en vol, en 2007.}{frise:Breitling_Orbiter_3_aloft.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Breitling_Orbiter_3_aloft.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Le 28 mai 1999, Caroline Aigle est brevetée pilote de chasse. Elle devient la première femme française pilote de chasse. Elle sera notamment affectée sur Mirage 2000.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Le 11 septembre 2001, des terroristes détournent des avions aux États-Unis et s'en servent comme projectiles pour commettre des attentats sur des bâtiments civils et militaires. Ces attentats feront environ 3000 morts entre les passagers dans les avions et ceux présents dans les cibles au sol et plusieurs dizaines de blessés.

Les attentats du 11 septembre constituent un tournant dans l'aéronautique mondiale. Ils forceront les autorités aériennes à revoir tous les processus de sûreté dans les aéroports et les avions.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{09 mai 2003} - \textbf{Hayabusa, première collecte d'échantillon d'un astéroïde}
            
            Avec leur sonde Hayabusa, lancée par leur lanceur M-V, les Japonais deviennent la première nation à collecter et à ramener sur Terre des échantillons d'un astéroïde.

Les échantillons sont récupérés sur Terre en 2010.

En 2014, le Japon réitérera la mission avec succès, avec Hayabusa II, qui ramenera plus de 5 kg d'échantillons lors de son retour sur Terre en 2020.
            \begin{figure}[H]
                \legende{Maquette de la sonde Hayabusa 2 à l'échelle 1}{frise:Full-scale_model_of_Hayabusa_22C_JAXA_02-cropped.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Full-scale_model_of_Hayabusa_22C_JAXA_02-cropped.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{29 septembre 2011} - \textbf{Station spatiale chinoise Tiangong 1}
            
            La Chine lance sa station spatiale et devient ainsi la troisième nation (après l'URSS/Russie et les USA) à lancer seule une station orbitale. Cette station permettra à 2 équipages d'y vivre sur des missions d'environ 2 semaines, avant la fin de vie opérationnelle de cette station, en 2016.

Depuis 2021, la Chine assemble sa propre station spatiale.
            \begin{figure}[H]
                \legende{Maquette de la station}{frise:Model_of_the_Chinese_Tiangong_Shenzhou.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Model_of_the_Chinese_Tiangong_Shenzhou.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            \begin{figure}[H]
                \legende{La chute libre supersonique de Felix Baumgartner d’une altitude de 39 km – Temps forts de la mission}{frise:felixBaumgartner.png}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/extraitsVideo/felixBaumgartner.png}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{12 novembre 2014} - \textbf{La sonde Rosetta dépose l'atterrisseur Philae sur la comète Tchouri}
            
            Lancée en 2004, la sonde Rosetta de l'agence spatiale européenne a pour but d'étudier la comète 67P/Tchourioumov-Guérassimenko (surnommée "Tchouri").

Après 10 ans de voyage, la sonde est mise en orbite autour de la comète début 2014, puis l'atterrisseur Philae se pose sur la comète le 12 novembre 2014
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    \begin{tabular}{c l c}
        \begin{minipage}{.075\textwidth}
            ...
            \setlength{\belowcaptionskip}{-40pt}
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Flag_of_Brazil.pdf}
                \captionsetup{labelformat=empty}\refDrapeau{Drapeau Brazil}{frise:Flag_of_Brazil.pdf}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.65\textwidth}
            \textbf{2015} - \textbf{Embraer : troisième constructeur mondial d'avions de ligne}
            
            Le constructeur aéronautique brésilien devient le troisième constructeur d'avion de ligne derrière Airbus et Boeing.
            \begin{figure}[H]
                \legende{Embraer E195-E2}{frise:Berlin_Brandenburg_Airport_KLM_Cityhopper_Embraer_E195-E2_PH-NXC_28DSC0287829.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Berlin_Brandenburg_Airport_KLM_Cityhopper_Embraer_E195-E2_PH-NXC_28DSC0287829.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Thomas Pesquet devient le dixième astronaute français. Après sa première mission de novembre 2016 à juin 2017, il effectue un second séjour dans l'ISS d'avril à novembre 2021. Le 4 octobre 2021, il devient commandant de l'ISS, ce qui fait de lui le premier français à remplir cette fonction.

Durant ses presque 400 jours dans l'espace, Thomas Pesquet effectuera un total de 6 sorties extra-véhiculaires.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{05 mai 2017} - \textbf{Comac C919 : premier avion de ligne chinois}
            
            Les chinois réalisent le premier vol du C919, un avion de ligne biréacteur moyen courrier. L'appareil est certifié quelques années plus tard et entre en service dans des compagnies chinoises.

Cet appareil vient en concurrence de l'A320 et du B737.
            \begin{figure}[H]
                \legende{Le C919 en vol}{frise:B-919A40PEK_282022122615172229.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/B-919A40PEK_282022122615172229.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{c l c}
        \begin{minipage}{.075\textwidth}
            ...
            \setlength{\belowcaptionskip}{-40pt}
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Flag_of_Slovenia.pdf}
                \captionsetup{labelformat=empty}\refDrapeau{Drapeau Slovenia}{frise:Flag_of_Slovenia.pdf}
            \end{figure}
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{10 juin 2020} - \textbf{Le Velis Electro : premier avion électrique certifié au monde}
            
            L'avion biplace de la société slovène Pipistrel est certifié par l'EASA et devient le premier avion électrique certifié au monde.
            \begin{figure}[H]
                \legende{Velis Electro en vol}{frise:Pipistrel_Velis_Electro_9992.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Pipistrel_Velis_Electro_9992.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
...
Ingenuity prouve largement ses capacités en effectuant en tout 72 vols et en parcourant un total de 17 km, pour un temps de vol total de 128,8 minutes (jusqu'à la casse d'une pale en janvier 2024).
            \begin{figure}[H]
                \legende{Ingenuity sur le sol martien}{frise:Mars_helicopter_on_sol_46.png}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Le 13 février 2026, Sophie Adenot décolle à bord d'une fusée Space X à destination de la station spatiale internationale. Elle devient la seconde femme française astronaute.
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{01 avril 2026} - \textbf{Christina Koch, première femme à quitter l'orbite terrestre}
            
            Le premier avril 2026, une fusée SLS décolle du centre spatial Kennedy et lance la mission Artemis II. A bord de la capsule, 4 astronautes américains, dont l'astronaute Christina Koch. Leur destination : la lune. La mission doit en effet les emmener autour de notre satellite. Cette mission fera de Christina Koch la première femme à quitter l'orbite terrestre.
            \begin{figure}[H]
                \legende{Lancement de la mission Artemis II le 1er avril 2026 UTC.}{frise:Artemis_II_Launch_28NHQ20260401021529.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
            \begin{figure}[H]
                \centering
                \includegraphics[width=1.0\linewidth]{Annexes/friseChronologique/img/Artemis_II_Launch_28NHQ20260401021529.jpg}
            \end{figure}
        \end{minipage}
    \end{tabular}
\end{table}
