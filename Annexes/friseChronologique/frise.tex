...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            L'ingénieur français Paul Cornu réalise le premier vol d'un hélicoptère à deux rotors contrarotatifs, s'élevant d'environ 1,5 mètre du sol pendant 20 secondes. Cette date marque la naissance de l'hélicoptère, mais ce vol n'es pas considéré comme complètement contrôlé, ainsi on retientiendra également 1936 et le vol du Focke-Wulf 61 comme véritable naissance de l'hélicoptère utilisable opérationnellement.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Roald Amundsen, norvégien célèbre pour avoir été le premier à rejoindre le pôle Sud, sera également le premier à survoler l'un des pôle de notre planète, graâce à un dirigeable de type Norge N1.
            \begin{figure}[H]
                \legende{DIrigeabl Norge N1 utilisé pour l'atteinte du pôle Nord}{frise:Norge_airship_in_flight_1926.jpg}
            \end{figure}
        \end{minipage}
    &
        \begin{minipage}{.275\textwidth}
...
Si la France n'est que la sixième nation à lancer une satellite, elle est la troisième à le faire avec sa propre fusée, aprés les soviétiques (1957, Spoutnik 1) et les Etats-Unis (1958, Explorer 1), ce qui fait de la France la 3ieme puissance spatiale.
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            "Un petit pas pour l'Homme, un bond de géant pour l'Humanité". Neil Armstrong est le premier humain à fouler le sol lunaire durant la mission Appolo 11. Leur vaisseau lunaire, propulsé par une fusée Saturne 5, lui permettra, ainsi qu'a ses collègues de mission, Buzz Aldrin et Michael Collins (ce dernier étant resté en orbite autour de la Lune durant la mission), de rentrer dans l'Histoire.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Les soviétiques mettent en orbite la première station spatiale. Après qu'un premier équipage soit parvenu à accoster à la station sans pouvour y pénétrer, un équipage y vivra pendant 23 jours.
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            En 1986, les soviétiques lancent la station Mir (du russe Мир :"Paix"). C'est la première station spatiale occupée de façon prolongée puisqu'elle sera en orbite jusqu'en 2001 et connaitra un période d'occupation permanente pendant 10 ans, de 1989 à 1999.

Cette station verra également naitre la véritable coopération spatiale puisqu'elle s'ouvrira progressivement aux astronautres non soviétiques ou russes, avec l'accueil d'astronautes américains, européens, japonnais ou encore indiens. La coopération aboutira même au programme Shuttle-Mir, qui permettra l'accostage des navettes spatiales américaines à la station.
            \begin{figure}[H]
...
Ce vol d'essai sera réalisé sans équipage, la navette réalisant de façon automatique toutes les procédures de désorbitage et d'atterissage, ce qui est une caractéristique unique pour une navette spatiale (la navette américaine n'a pas cette capacité).
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            \textbf{01 mars 1999} - \textbf{Bertrand Piccard réalise le premier tour de monde en ballon sans escale}
            
            Bertrand Picard réalise, à la troisième tentative, le premier tour de monde sans escale en ballon de l'histoire, grâce au Breitling Orbiter III, un ballon à l'hélium conçu spécialement pour ce record. Ce ballon est notamment équipé d'une nacelle pressurisée.
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Avec leur sonde Hayabusa, lancée par leur lanceur M-V, les japonnais devienent la première nation à collecter et à ramener sur Terre des échantillons d'un astéroïde.

Les échantillons sont récupérés sur Terre en 2010.

En 2014, le Japon réiterera la mission avec succès, avec Hayabusa II, qui ramenera plus de 5 kg d'échantillons lors de son retour sur Terre en 2020.
            \begin{figure}[H]
...
\begin{table}[H]
    ...
    &
        \begin{minipage}{.65\textwidth}
            ...
            Les chinois réalisent le premer vol du C919, un avion de ligne biréacteur moyen courrier. L'appareil est certifié quelques années plus tard et entre en service dans des compagnies chinoises.
