...
\begin{itemize}
	...
	\item un brûleur permet de chauffer l'air du ballon
	\item déplacement soumis au vent
\end{itemize}

\only<2>{\histoire{Invention française des frères Montgolfier

1783 : premier vol : un coq, un mouton et un canard puis Pilâtre de Rozier
...
\only<2>{\histoire{Invention du français Jacques Charles, en 1783}}
