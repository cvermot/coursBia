...
\begin{itemize}
	...
	\item corrige le principale défaut des ballons : leur manque de dirigeabilité
\end{itemize}
...
Parmi les aéronefs, les ULM sont très représentés en France. Ils sont regroupés en 6 classes en fonction de leur caractéristiques :
\begin{figure}[H]
  	\centering
...
\begin{itemize}
	...
	\item formes très différentes selon que leur mission sera constitué de simples survols du ou des corps célestes étudiés ou si au contraire elles doivent s'y poser
\end{itemize}
