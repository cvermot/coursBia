...
\section{Les groupes motopropulseurs}
	...
	\subsection{Moteurs à pistons}
		...
		\begin{figure}[H]
  		\centering
    		\input{1-EtudeAeronefs/img/Cycle4Temps/0-MoteurLegende.tex}
		...
		\begin{figure}[H]
  		\centering
    		\input{1-EtudeAeronefs/img/Cycle4Temps/1-Admission.tex}
		...
		\begin{figure}[H]
  		\centering
    		\input{1-EtudeAeronefs/img/Cycle4Temps/2-Compression.tex}
		...
		\begin{figure}[H]
  		\centering
		\input{1-EtudeAeronefs/img/Cycle4Temps/3-Explosion.tex}
		...
		\begin{figure}[H]
  		\centering
		\input{1-EtudeAeronefs/img/Cycle4Temps/5-Echappement.tex}
