...
\begin{document}
 ...
 \section{Les axes}
	...
	\pause
	\question{Qu'est-ce qui permet, sur l'aéronef, d'agir sur ces axes ?}
	\end{frame}	 

 	\begin{frame}{Les axes sur un aéronef}
		\begin{figure}[H]
  			\only<1| handout:0>{\includegraphics[scale=1]{imgPresentations/axes.pdf}}
...
\section{Commandes de vol}
	...
	\end{column}
 	\begin{column}{0.5\textwidth}
	La traînée supplémentaire créée par l'augmentation de la portance provoque un lacet dans le sens inverse au virage
	\end{column}
	\end{columns}
	\end{frame}
	...
	\begin{itemize}
		...
		\item la gouverne monte quand on tire sur le manche, et descend quand on pousse,
	...
	Sur des avions légers et peu rapides, le lien entre le manche et les surfaces de contrôle est réalisé grâce à des jeux de câbles, poulies et renvois.
	...
	\begin{frame}{Actionnement des commandes de vol}
	Sur des avions plus lourds ou plus rapides, la taille des surfaces de contrôle devient importante. Les efforts aux commandes de vol deviennent importants. On assiste donc les commandes de vol via des systèmes hydrauliques.
	...
	\begin{frame}{Commandes de vol électriques}
		...
		\histoire{Premier avion commercial avec commandes de vol électriques : Concorde (1976)
		 ...
		 Suivi par Boeing en 1994 avec le B777}
	\end{frame}
...
\begin{frame}{Stabilité - centre de gravité}
	\begin{figure}[H]
  		\includegraphics[width=0.95\textwidth]{04-Aerodynamique/img/centrage.pdf}
...
\begin{frame}{Stabilité - centre de gravité}
	...
	\begin{figure}[H]
  		\includegraphics[width=1\textwidth]{04-Aerodynamique/img/balanceCentrage.pdf}
  		\legende{Le centre de gravité à l'image d'une balance}{img:balanceCentrage}	
	\end{figure}	 
	\end{column}
	\begin{column}{0.55\textwidth}
	On peut voir l'avion comme une balance :
	\begin{itemize}
		\item le pivot est situé au niveau du foyer
		\item le premier plateau est représenté par le centre de gravité
		\item le second plateau est la force de déportance de la profondeur
	\end{itemize}
	\pause
	Centrage avant : plus stable, moins réactif
	
	Centrage arrière : moins stable, plus réactif	
	\end{column}
	\end{columns}
\end{frame}
...
\qmcBia{Étude des aéronefs}
{4}{La position du centre de gravité d'un avion a un effet important sur la stabilité et la maniabilité de l'avion, un centrage avant rend l'avion :	}
{maniable mais moins stable autour de l'axe de tangage}
{maniable et stable autour de l'axe de tangage}
{peu maniable et moins stable autour de l'axe de tangage}
{peu maniable mais stable autour de l'axe de tangage} 
{}

\qmcBia{Étude des aéronefs}
{2}{L'utilisation de l'hydraulique pour les commandes de vol permet :}
{un gain de poids}
{de diminuer les efforts du pilote}
{de ne pas avoir de maintenance sur cette partie de l'avion}
{d'avoir un train rentrant grâce au circuit hydraulique (on n'installe pas un circuit hydraulique uniquement pour le train rentrant)}  
{}
