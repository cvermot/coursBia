\section{Réglementation aéronautique}
	\subsection{Les organisations}
		...
		L'\acrshort{oaci} (\acrlong{oaci} \anglais{International Civil Aviation Organization, ICAO}) a été fondée en 1944 par la convention de Chicago, son siège est à Montréal (Canada). Elle regroupe la majorité des états du monde (192 en 2025). \\
