\section{Navigation}
	...
	\subsection{Les grands principes de navigation}
		...
		\paragraph{Déclinaison magnétique}
			Le champ magnétique terrestre n'est pas homogène sur l'ensemble de la planète, ce qui implique que l'angle séparant le pôle magnétique du pôle géographique varie selon ou l'on se trouve la planète.
			...
			Les lignes indiquées sont sur cette carte sont dites lignes isogoniques (lignes de même déclinaison magnétique) \\
			...
			\astuce{En France et plus globalement en Europe de l'ouest, nous méridionale, nous avons la chance d'avoir une déclinaison magnétique faible voir nulle. Cependant, en certains points de la planète, la prise en compte de la déclinaison en navigation est primordiale car elle peut atteinte plusieurs dizaines de degrés, notamment lorsque l'on se rapproche des pôles.} 	
