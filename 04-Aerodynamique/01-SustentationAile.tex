...
\end{itemize}
	...
	\astuce{Pour se souvenir ou sont situés l'intrados et l'extrados : quand l'avion vole à plat, l'extrados fait face à l'extérieur de la planète, l'intrados regarde vers l'intérieur de la planète.} 
...
Il est possible de tracer sur un graphique la portance (Cz) en fonction de la trainée (Cx) (voir également \href{\urlSite /polaireCxCz.html}{cette activité en ligne}\footnote{\urlSite /polaireCxCz.html} qui illustre la construction de la polaire).
...
\subsection{Stabilité}
	...
	\alert{Un centre de gravité en avant augmente la stabilité mais réduit la maniabilité. \\Un centre de gravité en arrière réduit la stabilité mais augmente la maniabilité.}
