...
\subsection{Dispositifs hypersustentateurs et destructeurs de portance}
	...
	\definition{Lorsqu'un appareil a tous ses dispositifs hypersustentateurs rentrés, on dit qu'il est en  \textbf{\gls{configuration lisse}}.}
		...
		Les volets d'intrados sont moins fréquemment utilisés sur les avions modernes. Ils augmentent la portance mais également la trainée dans des proportions très importantes. Ce type de volet est souvent assimilé à des servofreins. 
		\begin{figure}[H]
			\centering
		...
		\end{figure}
			...
			Le volet Fowler (du nom de son inventeur américain Harlan Fowler) se déploie sur le bord de fuite. Il augmente donc la portance en influant sur la surface de l'aile.
		\begin{figure}[H]
			\centering
