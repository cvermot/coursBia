...
\subsubsection{Répartition des pressions autour d'une aile}
	...
	\begin{center}
		...
		\legende{Mise en évidence d'un tourbillon marginal gâce à un fumigène}{img:vortex}
		\end{minipage}
		\end{figure}
		\end{minipage}
	\end{center}	
	...
	Le planeur EB29 existe avec 3 envergures différentes, et permet d'illustrer l'impact de l'allongement sur les traînée, en étudiant la valeur de la finesse (voir paragraphe \ref{chap:aero:finesse} \nameref{chap:aero:finesse}).
	...
	\begin{tabular}{|c|c|c|c|}
		\hline
		Envergure & Surface alaire & Allongement & Finesse max \\ 
		\hline
		\hline
		...
		\hline
	\end{tabular}
	\caption{Impact de l'allongement sur la trainée, et donc la finesse, pour les 3 versions du planeur EB39}
	\end{table}
	

\subsection{La portance}
Sur un aérondyne, on cherche à générer avec l'aile une force orientée vers le haut donc opposée au poids. Cette force est nommée portance.
...
\begin{figure}[H]
	...
	On constate sur ce graphique que la valeur du coefficient de portance augmente avec l'incidence pour atteindre une valeur maximale après laquelle il chute rapidement.
...
\begin{table}[H]
	...
	\begin{tabular}{|l|c|}
		...
		\hline
		Planeur de compétition (EB29) & 60 \\
		\hline
	\end{tabular}
	\caption{Quelques valeurs de finesse typique}
	\end{table}
