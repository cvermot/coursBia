...
\subsubsection{Répartition des pressions autour d'une aile}
	...
	\exemple{Le planeur EB29 existe avec 3 envergures différentes, et permet d'illustrer l'impact de l'allongement sur les traînée, en étudiant la valeur de la finesse (voir paragraphe \ref{chap:aero:finesse} \nameref{chap:aero:finesse}).
    \begin{table}[H]
	\centering
...
\exemple{\begin{table}[H]
	...
	\begin{tabular}{|l|c|}
		...
		\hline
		Navette spatiale & \begin{tabular}{@{}c@{}}1 en hypseronique \\ 2 en supersonique \\ 4.5 en subsonique\end{tabular} \\
		\hline
	\end{tabular}
