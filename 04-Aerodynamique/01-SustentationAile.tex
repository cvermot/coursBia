...
Il est possible de tracer sur un graphique la portance (Cz) en fonction de la traînée (Cx) (voir également \href{\urlSite /polaireCxCz.html}{cette activité en ligne}\footnote{\urlSite /polaireCxCz.html} qui illustre la construction de la polaire).
